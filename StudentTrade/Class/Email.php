...
class Email {
	...
	public function __construct() {
		...
		if ($this->emailSettings == "crystone") {
			// $this->mail->Host 		= "smtp.crystone.se";
			$this->mail->Host 		= "localhost";
			// $this->mail->Port 		= 587;
			$this->mail->SMTPAuth   = false;
		} else if ($this->emailSettings == "gmail") {
			...
			$this->mail->Username = "studenttrade.se@gmail.com";
			//Password to use for SMTP authentication
			$this->mail->Password = "aioyimvwuahwrdte";
		}
